 ...
 * The Board implements the ActionListener interface and detects user inputs via an added KeyListener from the player Object.
 * The Board initialises as well the graphics drawing and hands over the graphics to the ShapeContainer to be drawn.
